...
export const showDateTime = (sqlDT, options = {
    locale: 'en-us',
    tz: 'UTC',
    format: '',
    dateOnly: false,
    ...
    if (typeof sqlDT === 'string') {
        ...
        dt = new Date(Date.UTC(parseInt(dtString[0]), parseInt(dtString[1]) - 1, parseInt(dtString[2]), parseInt(dtString[3]), parseInt(dtString[4]), parseInt(dtString[5])));
    }
    else {
        dt = sqlDT;
    }
