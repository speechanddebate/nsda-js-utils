...
import { ordinalize, escapeCSV, emailValidator, affName, negName, normalizeSide, displaySide, roundName, } from './strings.js';
...
describe('Side helpers', () => {
    it('should return the correct sides', () => {
        ...
        assert.strictEqual(normalizeSide('Other'), 'Other', 'Correct other name');
