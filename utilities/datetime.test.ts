...
describe('Academic Year helper', () => {
	...
	it('should return the academic year for a specified year', () => {
		assert.strictEqual(
			academicYear(2017),
			'2017-2018',
			'Correct date for number',
		);
		assert.strictEqual(
			academicYear('2017'),
			'2017-2018',
			'Correct date for string',
		);
	});
});
...
describe('Condense date range helper', () => {
	...
	it('should handle date-only strings', () => {
		assert.strictEqual(
			condenseDateRange('2017-08-01', '2017-08-02'),
			'8/1/2017 - 8/2/2017',
		);
	});
	...
	it('should ignore timezone offsets on datetime strings', () => {
		assert.strictEqual(
			condenseDateRange('2017-08-01 23:00:00', '2017-08-01 23:00:00'),
			'8/1/2017',
		);
		assert.strictEqual(
			condenseDateRange('2017-08-01T23:00:00Z', '2017-08-01T23:00:00Z'),
			'8/1/2017',
		);
	});
});
